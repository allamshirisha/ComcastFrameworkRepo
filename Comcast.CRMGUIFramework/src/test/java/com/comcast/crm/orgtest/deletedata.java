...
String orgnmae = eu.getDataFromExcel("org", 10, 2) + ju.getRandomNumber();
WebDriver driver;
...
//sarch org name 
op.getSearchbox().sendKeys(orgnmae);

wb.select(op.getSearchdropdown(),"Organization Name" );
op.getSearchbutton().click();

Thread.sleep(1000);
//dynamic webtable select and delete org
driver.findElement(By.xpath("//a[text()='"+orgnmae+"']/../../td[8]/a[text()='del']")).click();
